...
## 1. Prerequisites
Familiarize yourself with your Radio Bridge hardware by setting it up using Radio Bridge's [getting started page](https://radiobridge.com/documents/Quick%20Start%20Guide%20for%20Radio%20Bridge%20Sensors.pdf) and ensure Radio Bridge has an active connected device.<br>
...
1.) Navigate to '*Solutions*'->'*+ New Solution*'->'*Add a product*'<br>
2.) Choose a name for your product, could be as simple as '*radiobridge*', and select "*RadioBridge Product Template*" as the starting point.<br>
